/*****
 * History
 * 2015-05-21 Add Ignore Field concept. eg. App
 */
...
public class JPAUtil {
	public final String CLASSNAME = "JPAUtil";
	...
	public JPAUtil(TreeMap<String, ?> f, List a, List ignoreFields) {
		this.fields = f;
		this.wildCardFields = a;
	...
	public Object clone(Object obj, String newGuid) {
		...
		try {
			...
			PortalLogger.error(CLASSNAME, METHODNAME, "JPAUtil.clone Exception:", e);
			return null;
		}
	}
	...
	/*** 2015-05-21 Add Ignore Field concept ***/
	private boolean shouldIgnore(String key) {
		if (this.fields.get(key) == null) {
			return true;
		} else if (this.ignoreFields != null && this.ignoreFields.contains(key)) {
			return true;
		} else
			return false;
	}
