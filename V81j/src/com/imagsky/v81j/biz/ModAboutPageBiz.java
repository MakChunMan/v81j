...
public class ModAboutPageBiz extends BaseModuleBiz {
	public static final String CLASSNAME = "ModAboutPageBiz";

	private Module returnModule;

	@Override
	public Module execute(ModuleBiz biz, String actionCode, Map paramMap) throws BaseException {
	...
	private Module doUpdate() {
		...
		try {
			...
			PortalLogger.error(CLASSNAME, METHODNAME, "ModAboutPageBiz.doUpdate()", e);
		}
		return enqObj;
	}
	...
	private Module doFind() {
		...
		try {
			...
			PortalLogger.error(CLASSNAME, METHODNAME, "ModAboutPageBiz.doFind()", e);
		}
		return enqObj;
	}
	...
	private Module doCreate() {
		...
		try {
			...
			PortalLogger.error(CLASSNAME, METHODNAME, "ModAboutPageBiz.doCreate()", e);
		}
		return newMod;
	}
	...
	private Module doDelete() {
		...
		try {
			...
			PortalLogger.error(CLASSNAME, METHODNAME, "ModAboutPageBiz.doDelete()", e);
		}
		return newMod;
	}
}
